@tag
Feature: Institution User - Check the flow of User Generate Single Mobile Number With above 10 digits

  @sanity
  Scenario: Verify the flow of Institution User Generate Single Mobile Number With above 10 digits
