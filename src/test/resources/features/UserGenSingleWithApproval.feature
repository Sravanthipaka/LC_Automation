@tag
Feature: Check the flow of Institute User Generate Single With Approvals

  @tag1
  Scenario: Verify the flow of Institute User Generate Single With Approvals
    Given login by Admin Username and password by the user
    Then click the adminsettings dropdown1
    Then select on settings1
    Then click the Approval checkbox1
