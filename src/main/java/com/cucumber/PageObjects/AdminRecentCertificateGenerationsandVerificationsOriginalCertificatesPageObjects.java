...
public class AdminRecentCertificateGenerationsandVerificationsOriginalCertificatesPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public AdminRecentCertificateGenerationsandVerificationsOriginalCertificatesPageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void clickthedownoadoriginalcertificatesRecentCertificateGenerations() throws InterruptedException {
	...
	public void clickbytheDownloadoriginalcertficatesRecentCertificateVerifications() throws InterruptedException {
