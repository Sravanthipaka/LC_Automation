...
public class UserVerifyCertificateWithoutSpecialcharactersVerifierEmailPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	By SYear=By.xpath("//*[@class='form-control ng-pristine ng-invalid has-error ng-touched']");

	By VName=By.xpath("//input[@name='VerifierName']");
	By VEmail=By.xpath("//input[@placeholder='Verifier Email']");
	By VMobile=By.xpath("//input[@name='VerifierMobile']");
	By Next=By.xpath("//button[text()='Next']");

	public UserVerifyCertificateWithoutSpecialcharactersVerifierEmailPageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void select_a_certificate_Type() throws Throwable {
		...
		s1.selectByVisibleText("Computer");
		Thread.sleep(4000);
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("window.scrollBy(0,4000);");
	}

	public void enter_the_Student_details() throws Exception
	{
	...
	public void enter_the_Verifier_details() {
		Constants.driver.findElement(VName).sendKeys("Deepthi");
		Constants.driver.findElement(VEmail).sendKeys("deepthi23gmail.com");
