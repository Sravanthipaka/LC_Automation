...
public class UserBulkByUploadingDOCXfilePageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	// Click Certificates tab and click on the generate bulk 
	...
	public UserBulkByUploadingDOCXfilePageObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();

	}  

	public void ClickCertificatestabandclickonthegeneratebulk() throws InterruptedException {
	...
	public void uploadtheDOCXfile() throws InterruptedException {
