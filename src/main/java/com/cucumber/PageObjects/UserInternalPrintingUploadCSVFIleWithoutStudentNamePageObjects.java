...
public class UserInternalPrintingUploadCSVFIleWithoutStudentNamePageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserInternalPrintingUploadCSVFIleWithoutStudentNamePageObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();
	}

	public void UsernavigatetoCertificatestype() throws InterruptedException {
	...
	public void userselecttheInternalPrinting() throws InterruptedException {
	...
	public void UserchoosetheappropriateCertificate() throws InterruptedException {
	...
	public void UploadingtheCSVFileemptystudentcolumn() throws Exception {
		WebElement fileInput = Constants.driver.findElement(Upload);
		Thread.sleep(4000);
		String filePath = "D:\\For Automation Purpose\\intercsv 11.csv";
	...
	public void Errormessageindicating () throws InterruptedException {
