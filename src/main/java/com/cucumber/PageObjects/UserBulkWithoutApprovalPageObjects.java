...
public class UserBulkWithoutApprovalPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserBulkWithoutApprovalPageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void uploadthePDFfiles() throws InterruptedException {
		...
		driver.findElement(By.id("fileInput")).sendKeys("C:\\Users\\admin\\Desktop\\BULK Data (2-28-24)\\marina-obooko (4)-54.pdf");
