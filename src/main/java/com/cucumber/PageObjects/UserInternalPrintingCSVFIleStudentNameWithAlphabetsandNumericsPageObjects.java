...
public class UserInternalPrintingCSVFIleStudentNameWithAlphabetsandNumericsPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserInternalPrintingCSVFIleStudentNameWithAlphabetsandNumericsPageObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();
	}

	public void user_navigate_to_Certificates_type_tab() throws InterruptedException {
	...
	public void user_select_the_internal_printing() throws InterruptedException {
	...
	public void user_choose_the_appropriate_Certificate() throws InterruptedException {
	...
	public void uploading_the_CSV_File_student_name_column_with_alphabets_and_numeric_values() throws Exception {
		WebElement fileInput = Constants.driver.findElement(Upload);
		Thread.sleep(4000);
		String filePath = "D:\\For Automation Purpose\\intercsv 9.csv";
	...
	public void error_message_indicating() throws InterruptedException {
