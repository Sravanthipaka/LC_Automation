...
public class UserGenerateBulkByUploadCSVFileWithEmptyStudentNamePageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenerateBulkByUploadCSVFileWithEmptyStudentNamePageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void clickOnGenerateBulk1() throws InterruptedException {
	...
	public void files_upload() throws InterruptedException {
		...
		Thread.sleep(4000);
		String csv1 = "D:\\For Automation Purpose\\data (9).csv";
		Thread.sleep(4000);
		csv.sendKeys(csv1);
