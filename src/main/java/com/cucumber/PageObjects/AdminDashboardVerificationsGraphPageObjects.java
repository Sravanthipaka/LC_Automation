...
public class AdminDashboardVerificationsGraphPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	//Click Verifications graph
	By graph = By.xpath("//*[name()='rect' and contains(@x,'157')]");



	public AdminDashboardVerificationsGraphPageObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();
	}

	public void scrollbythedown() throws InterruptedException {
	...
	public void ClickVerificationsgraph() throws InterruptedException {
