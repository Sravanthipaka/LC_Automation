...
public class ApprovalSettingPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public ApprovalSettingPageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void ClickOnSettings() throws InterruptedException {
		WebElement Settings = testbase.waitForElement(Constants.driver.findElement(settings), TIMEOUT_WAIT,
				POOLING_WAIT);
		Settings.click();
		Thread.sleep(3000);
