...
public class UserVerifyCertificateWithEmptyStudentNamePageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	By BGC= By.xpath("//a[text()='Verify Certificate ']");
	...
	public UserVerifyCertificateWithEmptyStudentNamePageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void enterStudentDetails() throws Exception {
		...
		Constants.driver.findElement(StudentName).sendKeys(" ");
