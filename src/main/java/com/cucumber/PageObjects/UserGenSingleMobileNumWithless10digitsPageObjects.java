...
public class UserGenSingleMobileNumWithless10digitsPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenSingleMobileNumWithless10digitsPageObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();
	}

	public void ClickCertificateandClickGenerateSingle2() throws InterruptedException {
	...
	public void ClickCertificateTypeDropdown1SelectCertificateType2() throws InterruptedException {
	...
	public void FilltheRequiredFields2() throws InterruptedException {
		...
		Constants.driver.findElement(mobile).sendKeys("75192438");
		Thread.sleep(2000);
