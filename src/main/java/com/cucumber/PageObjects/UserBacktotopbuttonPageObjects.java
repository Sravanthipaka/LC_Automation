...
public class UserBacktotopbuttonPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserBacktotopbuttonPageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void ClickontheBacktotopbutton() throws InterruptedException {
