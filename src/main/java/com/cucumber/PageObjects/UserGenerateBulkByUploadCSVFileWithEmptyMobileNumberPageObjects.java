...
public class UserGenerateBulkByUploadCSVFileWithEmptyMobileNumberPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenerateBulkByUploadCSVFileWithEmptyMobileNumberPageObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();
	}

	public void Theuserclicksonthecertificates() throws InterruptedException {
	...
	public void TheUserSelectsbulkcertificatesfromthemenu() throws InterruptedException {
	...
	public void TheUserchoosesanoptionfromthedropdownmenu() throws InterruptedException {
	...
	public void TheUseruploadsaJPGandaCSVfile() throws InterruptedException {
		...
		Thread.sleep(4000);
		String csv1 = "D:\\For Automation Purpose\\data (12).csv";
		Thread.sleep(4000);
		csv.sendKeys(csv1);

	}

	public void TheUserchecksthecheckboxandclicksthesavebutton() throws InterruptedException {
