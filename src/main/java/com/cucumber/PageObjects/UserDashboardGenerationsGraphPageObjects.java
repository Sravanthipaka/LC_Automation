...
public class UserDashboardGenerationsGraphPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserDashboardGenerationsGraphPageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void clickonGenerationsGraph() throws InterruptedException {
