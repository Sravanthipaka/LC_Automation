...
public class UserGenerateBulkUploadCSVFileEmailIdWithSpacesandDotsPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenerateBulkUploadCSVFileEmailIdWithSpacesandDotsPageObjects(WebDriver driver) {
		this.driver = driver;
...
//			Thread.sleep(4000);
//			
//			testbase.waitForElement(Constants.driver.findElement(upload_pdf), TIMEOUT_WAIT, POOLING_WAIT);
//			Constants.driver.findElement(upload_pdf).sendKeys("C:\\Users\\admin\\Desktop\\tiger.jpg");
//			
//			testbase.waitForElement(Constants.driver.findElement(upload_csv), TIMEOUT_WAIT, POOLING_WAIT);
//			Constants.driver.findElement(upload_csv).sendKeys("E:\\CSV_files");
		//	testbase.waitForElement(Constants.driver.findElement(upload_pdf), TIMEOUT_WAIT, POOLING_WAIT);
			...
			Thread.sleep(4000);
			String csv1 = "D:\\For Automation Purpose\\data (5).csv";
			Thread.sleep(4000);
			csv.sendKeys(csv1);
