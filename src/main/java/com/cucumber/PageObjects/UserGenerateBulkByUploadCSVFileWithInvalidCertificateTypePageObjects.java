...
public class UserGenerateBulkByUploadCSVFileWithInvalidCertificateTypePageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenerateBulkByUploadCSVFileWithInvalidCertificateTypePageObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();
	}

	public void theUserNavigatestotheCertificates1sectionfurther() throws InterruptedException {
	...
	public void SelectsBulkCertificates1fromthemenuoptionsforclick() throws InterruptedException {
	...
	public void Choosesanoptionfromthedropdownlistforselect() throws InterruptedException {
	...
	public void UploadsbothaJPGandaCSV1fileparallely() throws InterruptedException {
		...
		Thread.sleep(4000);
		String csv1 = "D:\\For Automation Purpose\\data (11).csv";
		Thread.sleep(4000);
		csv.sendKeys(csv1);

	}

	public void ChecksthecheckboxbeforeClickingonthesavebuttonandclicks() throws InterruptedException {
