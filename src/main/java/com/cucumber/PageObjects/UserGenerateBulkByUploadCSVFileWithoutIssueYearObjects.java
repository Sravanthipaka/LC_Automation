...
public class UserGenerateBulkByUploadCSVFileWithoutIssueYearObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenerateBulkByUploadCSVFileWithoutIssueYearObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();
	}

	public void proceedtothesectiontitledCertificatestab1() throws InterruptedException {
	...
	public void selecttheoptionlabeledBulkCertificates1() throws InterruptedException {
	...
	// Locate dropdown
	public void chooseanitemfromtheDropdown1() throws InterruptedException {
	...
	public void uploadbothaJPG1andaCSV1filessatatime() throws InterruptedException {
		...
		Thread.sleep(4000);
		String csv1 = "D:\\For Automation Purpose\\data (10).csv";
		Thread.sleep(4000);
		csv.sendKeys(csv1);

	}
	
	public void EnsurethattheCheckboxisSelectedbeforeSaveit() throws InterruptedException {
