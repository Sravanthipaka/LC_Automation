...
public class UserGenerateBulkByUploadCSVFileWithInvalidCertificateNamePageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenerateBulkByUploadCSVFileWithInvalidCertificateNamePageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void files_upload() throws InterruptedException {
		...
		Thread.sleep(4000);
		String csv1 = "D:\\For Automation Purpose\\data (7).csv";
		Thread.sleep(4000);
		csv.sendKeys(csv1);
