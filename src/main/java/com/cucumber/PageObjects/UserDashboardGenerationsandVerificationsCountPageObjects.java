...
public class UserDashboardGenerationsandVerificationsCountPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	By generation = By.xpath("//*[name()='rect' and contains(@x,'158')]");
	
    //Click the Verifications graph
	By verification = By.xpath("//*[name()='rect' and contains(@x,'157')]");



	public UserDashboardGenerationsandVerificationsCountPageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void clickbygenerationsGraphandviewcount() throws InterruptedException {
	...
	public void clicktheVerificationsgraphandseethecount() throws InterruptedException {
