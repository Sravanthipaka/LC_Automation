...
public class UserGenerateBulkByUploadCSVFileWithEmptyCertificateNamePageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenerateBulkByUploadCSVFileWithEmptyCertificateNamePageObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();
	}

	public void theusernavigatestoertificatessection() throws InterruptedException {
	...
	public void SelectsBulkCertificatesfromthemenu() throws InterruptedException {
	...
	public void UploadsbothaJPGandaCSVfileParallely() throws InterruptedException {
		...
		Thread.sleep(4000);
		String csv1 = "D:\\For Automation Purpose\\data (13).csv";
		Thread.sleep(4000);
		csv.sendKeys(csv1);
