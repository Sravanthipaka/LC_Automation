...
public class UserGenerateBulkUploadCSVFileWithEmptyAcademicRefNumColumn {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenerateBulkUploadCSVFileWithEmptyAcademicRefNumColumn(WebDriver driver) {
		this.driver = driver;
	...
	public void clickOnGenerateBulk() throws InterruptedException {
     ...
     public void clickOndropDown() throws InterruptedException {
		...
		public void files_upload() throws InterruptedException {
			...
			Thread.sleep(4000);
			String csv1 = "D:\\For Automation Purpose\\data (6).csv";
			Thread.sleep(4000);
			csv.sendKeys(csv1);
