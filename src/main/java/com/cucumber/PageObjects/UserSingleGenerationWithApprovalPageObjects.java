...
public class UserSingleGenerationWithApprovalPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserSingleGenerationWithApprovalPageObjects(WebDriver driver) {
		this.driver = driver;
	...
	public void Entertheinputfields() throws InterruptedException {
		...
		String img= "C:\\Users\\admin\\Desktop\\BULK Data (2-28-24)\\marina-obooko (4)-84.pdf";
