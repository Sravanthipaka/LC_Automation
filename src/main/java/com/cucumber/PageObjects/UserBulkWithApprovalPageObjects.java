...
public class UserBulkWithApprovalPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserBulkWithApprovalPageObjects(WebDriver driver) {
		this.driver = driver;
...
//		Thread.sleep(3000);
	...
	public void UploadpdfFiles() throws InterruptedException {
		...
		driver.findElement(By.id("fileInput")).sendKeys("C:\\Users\\admin\\Desktop\\BULK Data (2-28-24)\\marina-obooko (4)-68.pdf");
