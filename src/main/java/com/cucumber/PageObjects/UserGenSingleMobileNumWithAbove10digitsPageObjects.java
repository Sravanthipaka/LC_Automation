...
public class UserGenSingleMobileNumWithAbove10digitsPageObjects {
	WebDriver driver;
	Actions act;
	TestBase testbase;
	...
	public UserGenSingleMobileNumWithAbove10digitsPageObjects(WebDriver driver) {
		this.driver = driver;
		testbase = new TestBase();
	}

	public void clickthecertificate1andclickthegenerate1single() throws InterruptedException {
	...
	public void clicktheCertificatetype1Dropdown1SelecttheCertificateType3() throws InterruptedException {
	...
	public void fillbytherequiredfields3() throws InterruptedException {
		...
		Constants.driver.findElement(mobile).sendKeys("75192435464568");
		Thread.sleep(2000);
	...
	public void UploadDOCXfileintoUploadtheDocumentfield() throws InterruptedException {
		...
		String img= "C:\\Users\\admin\\Desktop\\Bulk Data\\loved-to-death-obooko-1.pdf";
